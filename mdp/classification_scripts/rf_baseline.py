    ...
    for index, row in info.iterrows():
        ...
        for trainSet in trainSets:
            ...
            for clf, name in zip(clfs, names):
                ...
                dump_name = './models/best_' + row['train_names'] + '_' + name + '_' + 'Ensemble-based' + '_non_trained.pkl'
                ...
                dump_name = './models/best_' + row['train_names'] + '_' + name + '_' + 'Ensemble-based' + '_trained.pkl'
                ...
                for test_set_name in testSets:
                    print("\n\nWill classify using", name, 'baseline', "on", test_set_name, "\n\n")
            ...
            all_results.to_csv('results/ensemble_static.csv', columns=df_final.columns.values, index=False)
