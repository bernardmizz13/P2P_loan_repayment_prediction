...
def getParamsClassifierEnsamble(classifierName):
    ...
    if classifierName == "Random Forest":
        return dict(clf__random_state=[935],
                    clf__n_estimators=[10, 50, 100],  # Good
    ...
    for index, row in info.iterrows():
        ...
        for trainSet, testSet, name in zip(trainSets, testSets, final_names):
            ...
            for clf, name in zip(clfs, names):
                ...
                # BM
                print("\n\nGrid search of", name, "Ensemble-based", "using", trainSet, "\n\n")
                ...
                print("\n\nFitting", name, "Ensemble-based", "on", trainSet, "\n\n")
                ...
                print("\n\nWill classify using", name, "Ensemble-based", "on", testSet, "\n\n")
